var noCookiesEnabledURI = "/error_msg/no_cookies.cfm";

$(document).ready(function() {
	if (!areCookiesEnabled()) {
		document.location.href = noCookiesEnabledURI;
	}

	if ($("form#frmVirtusLogin").find("#user_login").length > 0) {
		$("form#frmVirtusLogin").find("#user_login").focus();
	}
});
